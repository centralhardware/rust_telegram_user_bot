...
--
--   * `transcription`. The text Telegram produced for a voice message, in
--     `message` -- the send row has the audio, this row has what was said.
--     Partial results (`pending`) are not logged: each is a prefix of the final
--     one.
--
